...
function Navbar() {
  ...
  return (
    <div className="w-[7rem] h-[5rem] md:w-[8rem] md:h-[6rem] flex justify-between items-center px-[1.4rem] mb-[1.5rem] md:mb-[0.5rem] bg-[#1D1F24] rounded-[1.5rem] transition ease-in duration-300 cursor-pointer">
      <Link href="/metrics">
        <div
